...
class SecurityTerminal(QMainWindow):
    def __init__(self):
        ...
        # Добавляем валидаторы для полей
        ...
        # Добавляем кнопки "Добавить" и "Очистить"
        ...
        # Добавляем валидатор для действительности периода
        ...
        # Размещаем виджет в центре главного окна
    ...
    def find_user_in_database(self, pass_number, csv_path):
        # Определение абсолютного пути к файлу CSV
    ...
    def add_employee(self):
        ...
        # Валидация (проверка наличия значений в обязательных полях)
        ...
        # Открываем файл CSV для чтения текущих записей
        current_ids = set()
        try:
            ...
            pass  # Если файл не найден, текущие Id будут пустыми

        # Генерация Id на основе максимального Id в файле
        ...
        with open(employee_csv_path, 'a', newline='', encoding='utf-8') as csvfile:
            ...
            # Чтобы избежать использования BOM в начале файла
            if csvfile.tell() == 0:
                writer.writeheader()
